...
c.GetWorldCenter().y);k.Subtract(g.GetWorldCenter());k.Normalize();k.Multiply(j);k.Multiply(c.GetMass());!isNaN(k.x)&&!isNaN(k.y)&&c.ApplyForce(k,c.GetWorldCenter());void 0!=g.GetUserData().properties.gravityFactor&&b.push(parseFloat(g.GetUserData().properties.gravityFactor))}f=0;for(e=b.length;f<e;f++)h=h+b[f]||b[f];isNaN(h)||(f=this.b2dWorld.GetGravity().GetNegative(),f.Multiply(1-h/b.length),f.Multiply(c.GetMass()),c.ApplyForce(f,c.GetWorldCenter()))}}c=c.GetNext()}this.b2dWorld.Step((a||30)/1E3,
10,10);this.b2dWorld.ClearForces()};a.prototype.drawDebugData=function(a){a=a||1;this.b2dDebugDraw.SetFillAlpha(0.35*a);this.b2dDebugDraw.SetAlpha(1*a);this.b2dDebugDraw.GetSprite().save();this.b2dDebugDraw.GetSprite().scale(this.scaleX,this.scaleY);this.b2dDebugDraw.GetSprite().translate(-this.regX+this.x/this.scaleX,-this.regY+this.y/this.scaleY);this.b2dWorld.DrawDebugData();this.b2dDebugDraw.GetSprite().restore()};a.prototype.setupLayers=function(){var a,c,b,h;a=0;for(c=this.data.layers.length;a<
c;a++)b=this.data.layers[a],"tilelayer"==b.type?(h=new boxledjs.TileLayer(b,this),this.addChild(h)):"objectgroup"==b.type&&(h=new boxledjs.ObjectLayer(b,this),this.addChild(h)),b.name&&""!=b.name&&(this.layers[b.name]=h)};a.prototype.centerTo=function(a){"string"==typeof a&&(a=this.objects[a]);if(a&&void 0!=a){var c,b;a.GetPosition?(b=a.GetPosition(),c=b.x*boxledjs.Const.scale,b=b.y*boxledjs.Const.scale):void 0!=a.x&&void 0!=a.y&&(c=a.x,b=a.y);if(!(void 0==c||void 0==b)){a=this.viewPort.width||0;
var h=this.viewPort.height||0;this.regX=c;this.regY=b;this.x=a/2;this.y=h/2}}};a.prototype.generateTileSets=function(){this.tilesets=[];this.tileproperties={};for(var d=0,c=this.data.tilesets.length;d<c;d++){var b=a.convertTileSetToSpriteSheet(this.data.tilesets[d]);this.tilesets.push(b);for(var h in b.tileproperties)this.tileproperties[h]=b.tileproperties[h]}};a.prototype.getTileById=function(a){a-=1;return this.getSpriteSheetByTileId(a).getFrame(a)};a.prototype.getSpriteSheetByTileId=function(a){a=
a||1;var c=this.tilesets,b,h,f,e;b=0;for(h=c.length;b<h;b++)f=c[b],f.firstgid<=a&&0<f.firstgid&&(e=f);return e};a.prototype.getTileProperties=function(a){return this.tileproperties[a-1]};a.convertTileSetToSpriteSheet=function(a){var c={};c.images=[a.image];c.frames={width:a.tilewidth,height:a.tileheight};c=new createjs.SpriteSheet(c);c.firstgid=a.firstgid;c.tileproperties=a.tileproperties;return c};l.Map=a})(boxledjs);
