...
m)}}else if(d==Box2DUtils.CIRCLE)p.shape=new Box2D.Collision.Shapes.b2CircleShape(2*f/m);else throw Error("Cannot resolve shape-type: "+d);a.bxd.fixDef=p;if(!c){a.bxd.sensors={bottom:[],top:[],right:[],left:[],tr:[],br:[],bl:[],tl:[]};a.bxd.sensorsDef=sensorsDef;var r=[];a.isSensor=function(a){if(!this.bxd||!this.bxd.sensors)return!1;a=this.bxd.sensors[a];if(!a)return!1;for(var d=0,f=a.length;d<f;++d){trigger=a[d];var e=trigger.GetUserData();e&&e.object&&(e=e.object);var h=e.ignoreCollisionsWith||
(e.properties&&e.properties.ignoreCollisionsWith?e.properties.ignoreCollisionsWith:r),b=this.ignoreCollisionsWith||(this.properties&&this.properties.ignoreCollisionsWith?this.properties.ignoreCollisionsWith:r),h=0<=h.indexOf(this.subType)||0<=h.indexOf(this.type),b=0<=b.indexOf(e.subType)||0<=b.indexOf(e.type);if(!h&&!b&&!(!1==this.visible||!1==e.visible))return!0}return!1}}d=new Box2D.Dynamics.b2BodyDef;d.type=!j?Box2D.Dynamics.b2Body.b2_staticBody:Box2D.Dynamics.b2Body.b2_dynamicBody;a.bxd.bodyDef=
d;Box2DUtils.injectOnTick(a)},injectOnTick:function(a){a.onTick&&(a.__onTick=a.onTick);a.onTick=function(a){this.__onTick&&this.__onTick(a);if(this.bxd.body){a=this.bxd.body.GetPosition();if(-5E4>=a.x||-5E4>=a.y){var f=this;f.hideTO=setTimeout(function(){f.visible=!1},50)}else this.hideTO&&(clearTimeout(this.hideTO),delete this.hideTO),this.visible=!0;this.x=a.x*(boxledjs.Const.scale||32);this.y=a.y*(boxledjs.Const.scale||32);this.rotation=180*(this.bxd.body.GetAngle()/Math.PI)}}},makeSensorDef:function(a,
d,f,e){var h=new Box2D.Dynamics.b2FixtureDef;h.isSensor=!0;var b=new Box2D.Collision.Shapes.b2PolygonShape;b.SetAsOrientedBox(a,d,new Box2D.Common.Math.b2Vec2(f,e),0);h.shape=b;return h}};c.Box2DUtils=Box2DUtils})(boxledjs);
...
(function(c){function b(a,d,h,b,g,c){var k;if(k=(h+0.1>=a&&a>=g-0.1||h-0.1<=a&&a<=g+0.1)&&(b+0.1>=d&&d>=c-0.1||b-0.1<=d&&d<=c+0.1))0.1<g-h||0.1<h-g?(a=(c-b)/(g-h)*(a-h)+b,k=0.1>(a>d?a-d:d-a)):k=0.1>a-h||0.1>h-a;return k}function a(a,d,h,b){return 0.1>(h>=a?h-a:a-h)&&0.1>(b>=d?b-d:d-b)}function d(){throw Error("A problem has occurred. Use the Validate() method to see where the problem is.");}c.b2Separator={Separate:function(f,e,h,l){l=l||32;var g,c=h.length,k,n,m=[];for(g=0;g<c;g++)m.push(new Box2D.Common.Math.b2Vec2(h[g].x/
...
t&&w?new Box2D.Common.Math.b2Vec2(C,D):null)t=u.x-w.x,z=u.y-w.y,t=t*t+z*z,t<x&&(n=p,k=q,A=w,x=t)}x==Number.MAX_VALUE&&d();r=[];x=[];p=n;q=k;s=g[p];v=g[q];a(A.x,A.y,v.x,v.y)||r.push(A);a(A.x,A.y,s.x,s.y)||x.push(A);n=-1;for(k=m;;){if(k!=q)r.push(g[k]);else{(0>n||n>=c)&&d();b(v.x,v.y,g[n].x,g[n].y,y.x,y.y)||r.push(g[k]);break}n=k;0>k-1?k=c-1:k--}r=r.reverse();n=-1;for(k=B;;){if(k!=p)x.push(g[k]);else{(0>n||n>=c)&&d();k==p&&!b(s.x,s.y,g[n].x,g[n].y,u.x,u.y)&&x.push(g[k]);break}n=k;k+1>c-1?k=0:k++}h.push(r,
x);h.shift();break}E&&l.push(h.shift())}c=l.length;for(g=0;g<c;g++){h=[];m=l[g];n=m.length;for(k=0;k<n;k++)h.push(new Box2D.Common.Math.b2Vec2(m[k].x,m[k].y));k=new Box2D.Collision.Shapes.b2PolygonShape;k.SetAsArray(h);e.shape=k;f.CreateFixture(e)}},Validate:function(a){var d,h=a.length,c,g,j,k,n,m=0,p,r=!1;for(d=0;d<h;d++){j=d<h-1?d+1:0;k=0<d?d-1:h-1;p=!1;for(c=0;c<h;c++)if(c!=d&&c!=j&&(p||(n=a[d].x*a[j].y+a[j].x*a[c].y+a[c].x*a[d].y-a[d].y*a[j].x-a[j].y*a[c].x-a[c].y*a[d].x,0<n&&(p=!0)),c!=k)){g=
c<h-1?c+1:0;var q=a[d].x,t=a[d].y,z=a[j].x,x=a[j].y;n=a[c].x;var B=a[c].y,y=a[g].x;g=a[g].y;var u=z-q,s=x-t,v=y-n,w=g-B,A=void 0,A=(v*(B-t)-w*(n-q))/(s*v-u*w),u=q+A*u,s=t+A*s,q=b(u,s,q,t,z,x);n=b(u,s,n,B,y,g);n=q&&n?new Box2D.Common.Math.b2Vec2(u,s):null;n&&(m=1)}p||(r=!0)}r&&(m=1==m?3:2);return m}}})(Box2D.Ext);boxledjs=boxledjs||{};
(function(c){function b(){}b.prototype=new Box2D.Dynamics.b2ContactListener;var a=b.prototype;a.BeginContact=function(a){var f=a.GetFixtureA(),e=a.GetFixtureB();this.__BeginContactOrdered(f,e,a);this.__BeginContactOrdered(e,f,a)};a.__BeginContactOrdered=function(a,f,e){var h=a.GetBody().GetUserData(),b=f.GetBody().GetUserData();h&&h.objectData&&(h=h.objectData);b&&b.objectData&&(b=b.objectData);this.__applyForceField(a,f,h,b,1,1,e);this.__applyImpulse(a,f,h,b,e);this.__handleCustomEvents(a,f,h,b,
e,"beginContact")};a.EndContact=function(a){var f=a.GetFixtureA();a=a.GetFixtureB();this.__EndContactOrdered(f,a);this.__EndContactOrdered(a,f)};a.__EndContactOrdered=function(a,f,e){var h=a.GetBody().GetUserData(),b=f.GetBody().GetUserData();h&&h.objectData&&(h=h.objectData);b&&b.objectData&&(b=b.objectData);this.__applyForceField(a,f,h,b,-1,0,e);this.__handleCustomEvents(a,f,h,b,e,"endContact")};a.__applyForceField=function(a,f,e,b,c,g){if(e&&e.properties&&(e.properties.forceX||e.properties.forceY))if((e.properties.forceX||
...
(function(c){function b(){}b.prototype=new boxledjs.BoxledJSContactListener;var a=b.prototype;a.super_BeginContact=a.BeginContact;a.BeginContact=function(a){this.super_BeginContact(a);this.__HandleContact(a,1)};a.super_EndContact=a.EndContact;a.EndContact=function(a){this.super_EndContact(a);this.__HandleContact(a,-1)};a.__HandleContact=function(a,f){var e=a.GetFixtureA(),b=a.GetFixtureB(),c=e.IsSensor()?e:b.IsSensor()?b:null;if(c){e=e!=c?e:b;if((b=e.GetBody().GetUserData())&&b.objectData)b=b.objectData;
c.GetUserData();if(c.GetUserData()&&c.GetUserData().sensorPosition){var g=c.GetBody().GetUserData(),j=e.GetBody().GetUserData();if(j&&j.onContact)j.onContact(g,1==f);var k=c.GetUserData()&&c.GetUserData().sensorPosition;b&&b.properties&&b.properties.noBottomCollision&&("left"==k||"right"==k)||(e.IsSensor()||g==c||g==j)||g&&(g.bxd&&g.bxd.sensors&&k)&&(1==f&&-1==g.bxd.sensors[k].indexOf(e.GetBody())?g.bxd.sensors[k].push(e.GetBody()):-1==f&&0<=g.bxd.sensors[k].indexOf(e.GetBody())&&g.bxd.sensors[k].splice(g.bxd.sensors[k].indexOf(e.GetBody()),
...
0<=k.indexOf(c.type))a.SetEnabled(!1);else if(c&&c.properties&&c.properties.noBottomCollision||g&&g.properties&&g.properties.noBottomCollision)e.GetBody().GetDefinition().type==Box2D.Dynamics.b2Body.b2_staticBody?(g=b.GetBody().m_linearVelocity.y,j=b.GetBody().m_invMass,c=b.GetAABB(),e=e.GetAABB()):(g=e.GetBody().m_linearVelocity.y,j=e.GetBody().m_invMass,c=e.GetAABB(),e=b.GetAABB()),b=Math.abs(e.lowerBound.y-e.upperBound.y),g=g*j/Box2D.Dynamics.b2World.s_timestep2.velocityIterations,(c.upperBound.y-
g>e.upperBound.y&&c.upperBound.y>e.upperBound.y||c.upperBound.y-g>e.lowerBound.y+b/25&&c.upperBound.y>e.lowerBound.y+b/25)&&a.SetEnabled(!1)};c.PlatformerContactListener=b})(boxledjs);boxledjs=boxledjs||{};
...
a.bxd.sensorsDef.bl&&c.CreateFixture(a.bxd.sensorsDef.bl).SetUserData({object:a,sensorPosition:"bl"}),a.bxd.sensorsDef.tl&&c.CreateFixture(a.bxd.sensorsDef.tl).SetUserData({object:a,sensorPosition:"tl"}));c.SetPositionAndAngle(new Box2D.Common.Math.b2Vec2(a.x/boxledjs.Const.scale,a.y/boxledjs.Const.scale),a.rotation*Math.PI/180);a.bxd.sensorsDef=void 0;a.bxd.body=c;c.SetUserData(a);f=!0}}catch(l){}a.layer=this;d&&(d.name&&""!=d.name)&&(this.objects[d.name]=a,this.map.objects[d.name]=a);d&&(d.group&&
""!=d.group)&&(this.map.objectGroups[d.group]=this.map.objectGroups[d.group]||[],this.map.objectGroups[d.group].push(a));if(f&&a.onBodyCreated)a.onBodyCreated(c)};b.makeObjectFromData=function(a){var d,b,e,c=a.properties;d=boxledjs.Utils.getDefinitionByName(a.type||c.type||c.classDefinition);c.parameter&&""!=c.parameter&&(b="string"==typeof c.parameter?JSON.parse(c.parameter):c.parameter,"object"==typeof b&&(e=boxledjs.Utils.applyConstruct(d,b)));e=e||new d;for(var l in c)"classDefinition"!=l&&"parameter"!=
l&&(e[l]=c[l]);e.x=a.x;e.y=a.y;if(void 0!=a.scaleX||void 0!=c.scaleX)e.scaleX=a.scaleX||c.scaleX;if(void 0!=a.scaleY||void 0!=c.scaleY)e.scaleY=a.scaleY||c.scaleY;e.rotation=a.rotation;return e};c.ObjectLayer=b})(boxledjs);boxledjs=boxledjs||{};
...
[];for(d=0;d<this.numTilesX;d++){n=[];for(b=0;b<this.numTilesY;b++)e=b*this.numTilesX+d,c=a[e],j=this.map.getTileProperties(c),0!=c&&void 0!=c&&(j&&j.type&&""!=j.type?(l={},l.properties=j,l.x=d,l.y=b,g=boxledjs.ObjectLayer.makeObjectFromData(l),g.regX=this.map.data.tilewidth/2,g.regY=this.map.data.tileheight/2):(l=this.map.getTileById(c),g=new createjs.Bitmap(l.image),g.sourceRect=l.rect,g.regX=0.5*this.map.data.tilewidth,g.regY=0.5*this.map.data.tileheight),g.x=d*this.map.data.tilewidth+0.5*this.map.data.tilewidth,
g.y=b*this.map.data.tileheight+0.5*this.map.data.tileheight,g.properties=j,g.updateVisibility=function(a){var d;a=a||1;d=window.color||0;var b=this;if((7!=this.color||0>=this.triggered)&&this.bxd)if((this.color|d)!=d||0>=this.triggered){d=!1;if(this.currentVis==d)return!1;void 0==this.ox&&(this.ox=this.bxd.body.GetPosition().x,this.oy=this.bxd.body.GetPosition().y);setTimeout(function(){b.bxd.body.SetPosition(new Box2D.Common.Math.b2Vec2(-5E4,-5E4))},a)}else{d=!0;if(this.currentVis==d)return!1;void 0!=
this.ox&&setTimeout(function(){b.bxd.body.SetPosition(new Box2D.Common.Math.b2Vec2(b.ox,b.oy))},a)}else{d=!0;if(this.currentVis==d)return!1;void 0!=this.ox&&setTimeout(function(){b.bxd.body.SetPosition(new Box2D.Common.Math.b2Vec2(b.ox,b.oy))},a)}return d!=this.currentVis?(this.currentVis=d,!0):!1},this.addChild(g),this.tileObjects[e]=g),this.isCollisionLayer?(this.colTilesToCheck[e]=c,e=!Box2DUtils.isTileCollideable(j,c)):e=!j||"false"!=j.passable,n.push(e?GraphNodeType.OPEN:GraphNodeType.WALL);
k.push(n)}this.pathfinding.graph=new Graph(k)};b.prototype.calculateCollisionShapes=function(){var a,d,b,c,h=this.map.data.tilewidth,l=this.map.data.tileheight;for(b=0;b<this.numTilesY;b++)for(d=0;d<this.numTilesX;d++)a=b*this.numTilesX+d,a=this.colTilesToCheck[a],void 0!=a&&0!=a&&(this.colTileGroups.push({tiles:[]}),this.findNextCollisionShapeTile(d,b));a=0;for(c=this.colTileGroups.length;a<c;a++){var g=this.colTileGroups[a],j=g.tiles;d=j[0].x;b=j[0].y;j=j[j.length-1].x-d+1;g=this.map.getTileProperties(g.tileid)||
{};g={x:d*h,y:b*l,width:j*h,height:1*l,properties:g};j=boxledjs.Box2DUtils.makeB2DBodyFromData(g,this.map.b2dWorld);if(d=this.tileObjects[b*this.numTilesX+d]){if(j.SetUserData(d),d.bxd=d.bxd||{},d.bxd.body=j,Box2DUtils.injectOnTick(d),d.onBodyCreated)d.onBodyCreated(j)}else j.SetUserData(g)}};b.prototype.findNextCollisionShapeTile=function(a,d){a=a||0;d=d||0;var b,c,h;b=d*this.numTilesX+a;c=this.colTilesToCheck[b];if(void 0!=c&&0!=c&&(h=this.colTileGroups[this.colTileGroups.length-1],h.tileid=h.tileid||
c,Object.equals(this.map.getTileProperties(c),this.map.getTileProperties(h.tileid))&&!(h.tiles.length&&this.map.getTileProperties(c)&&void 0!=this.map.getTileProperties(c).type||h.tiles.length)))h.tiles.push({x:a,y:d,tileid:c}),this.colTilesToCheck[b]=void 0,this.findNextCollisionShapeTile(a+1,d)};c.TileLayer=b})(boxledjs);boxledjs=boxledjs||{};boxledjs.Const={};boxledjs.Const.scale=32;
...
new Box2D.Dynamics.b2World(new Box2D.Common.Math.b2Vec2(parseFloat(this.data.properties.forceX)||0,parseFloat(this.data.properties.forceY)||20),!0);var a=new boxledjs.PlatformerContactListener;this.b2dWorld.SetContactListener(a)}this.firstTick=!1;this.generateTileSets()};b.prototype.destroy=function(){var a,d;if(this.b2dWorld){for(d=this.b2dWorld.GetBodyList();d;){var b=d;d=d.GetNext();this.b2dWorld.DestroyBody(b)}delete this.b2dWorld}this.parent&&this.parent.removeChild(this);for(a in this.objects)d=
this.objects[a],d.destroy&&d.destroy(),d.parent&&(d.parent.removeChild(d),delete this.objects[a]);delete this.objects;for(a in this.layers)d=this.layers[a],d.destroy();delete this.layers;this.removeAllChildren();return!0};b.prototype.onTick=function(){!this._firstTick&&this._onFirstTick();this.centerObject&&this.centerTo(this.centerObject)};b.prototype._onFirstTick=function(){var a=boxledjs.Utils.getStage(this).canvas;void 0==this.viewPort.width&&(this.viewPort.width=a.width);void 0==this.viewPort.height&&
(this.viewPort.height=a.height);!this.b2dDebugDraw&&this.setupDebugDraw(a);this._firstTick=!0};b.prototype.update=function(a){if(this.initialized&&!1!==this.b2dWorld&&void 0!==this.b2dWorld){for(var d=this.b2dWorld.GetBodyList();d;){var b=d.GetUserData(),c=b?b.properties:{};if(b&&b.eventsToDispatch)for(;b.eventsToDispatch.length;){var h=b.eventsToDispatch.pop();this.dispatchEvent(h)}if(!c||!0!=c.ignoreForces){if(d.o_fieldForceX||d.o_fieldForceY)d.ApplyForce(new Box2D.Common.Math.b2Vec2((d.o_fieldForceX||
...
this.x/this.scaleX,-this.regY+this.y/this.scaleY),this.b2dWorld.DrawDebugData(),this.b2dDebugDraw.GetSprite().restore())};b.prototype.setupLayers=function(){var a,b,c,e,h=[];a=0;for(b=this.data.layers.length;a<b;a++)if(c=this.data.layers[a],"tilelayer"==c.type){e=new boxledjs.TileLayer(c,this);this.addChild(e);for(var l=e.pathfinding.graph.input,g=0,j=l.length;g<j;g++){var k=l[g],n=h[g]||[];h[g]=n;for(var m=0,p=k.length;m<p;m++)n[m]=(n[m]||1)&k[m]}c.name&&""!=c.name&&(this.layers[c.name]=e)}a=0;for(b=
this.data.layers.length;a<b;a++)c=this.data.layers[a],"objectgroup"==c.type&&(e=new boxledjs.ObjectLayer(c,this),this.addChild(e),c.name&&""!=c.name&&(this.layers[c.name]=e));this.pathfinding.graph=new Graph(h)};b.prototype.centerTo=function(a){"string"==typeof a&&(a=this.objects[a]);if(a&&void 0!=a){var b,c;a.GetPosition?(c=a.GetPosition(),b=c.x*boxledjs.Const.scale,c=c.y*boxledjs.Const.scale):void 0!=a.x&&void 0!=a.y&&(b=a.x,c=a.y);if(!(void 0==b||void 0==c)){a=this.viewPort.width||0;var e=this.viewPort.height||
0;this.regX=b;this.regY=c;this.x=a/2;this.y=e/2}}};b.prototype.calculatePath=function(a,b,c,e){var h=this.pathfinding.graph.nodes;a=h[a.x][a.y];b=h[b.x][b.y];if((a=astar.search(h,a,b,c))&&a.length&&!0===e){e=!1;for(var l,g=0;g<a.length-2;g++)for(e=!1;!e&&a[g+2];)b=a[g].x-a[g+1].x,c=a[g].y-a[g+1].y,h=a[g].x-a[g+2].x,l=a[g].y-a[g+2].y,0==h&&0==b||0==l&&0==c?a.splice(g+1,1):e=!0}return a};b.prototype.generateTileSets=function(){this.tilesets=[];this.tileproperties={};for(var a=this.loadedSets=0,c=this.data.tilesets.length;a<
c;a++){var f=b.convertTileSetToSpriteSheet(this.data.tilesets[a]);this.tilesets.push(f);for(var e in f.tileproperties){var h=f.tileproperties[e],l;for(l in h){var g=h[l];0==g.indexOf("[")&&(h[l]=JSON.parse(g))}this.tileproperties[e]=h}if(f.complete)this.loadedSets++;else{var j=this;f.addEventListener("complete",function(){j.setsLoaded()})}}this.loadedSets==c&&this.setsLoaded()};b.prototype.setsLoaded=function(){this.setsLoaded++;this.loadedSets==this.data.tilesets.length&&(this.setupLayers(),this.initialized=
