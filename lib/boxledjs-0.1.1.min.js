...
c.GetUserData();if(c.GetUserData()&&c.GetUserData().sensorPosition){var g=c.GetBody().GetUserData(),j=d.GetBody().GetUserData();if(j&&j.onContact)j.onContact(g);var k=c.GetUserData().sensorPosition;b&&b.properties&&b.properties.noBottomCollision&&("left"==k||"right"==k)||(d.IsSensor()||g==c||g==j)||g&&(g.bxd&&g.bxd.sensors&&k)&&(1==f&&-1==g.bxd.sensors[k].indexOf(d.GetBody())?g.bxd.sensors[k].push(d.GetBody()):-1==f&&0<=g.bxd.sensors[k].indexOf(d.GetBody())&&g.bxd.sensors[k].splice(g.bxd.sensors[k].indexOf(d.GetBody()),
...
a);e&&(e.group&&""!=e.group)&&(this.map.objectGroups[e.group]=this.map.objectGroups[e.group]||[],this.map.objectGroups[e.group].push(a))};b.makeObjectFromData=function(a){var e,b,d,c=a.properties;e=boxledjs.Utils.getDefinitionByName(a.type||c.type||c.classDefinition);c.parameter&&""!=c.parameter&&(b="string"==typeof c.parameter?JSON.parse(c.parameter):c.parameter,"object"==typeof b&&(d=boxledjs.Utils.applyConstruct(e,b)));d=d||new e;for(var l in c)"classDefinition"!=l&&"parameter"!=l&&(d[l]=c[l]);
d.x=a.x;d.y=a.y;if(void 0!=a.scaleX||void 0!=c.scaleX)d.scaleX=a.scaleX||c.scaleX;if(void 0!=a.scaleY||void 0!=c.scaleY)d.scaleY=a.scaleY||c.scaleY;d.rotation=a.rotation;return d};c.ObjectLayer=b})(boxledjs);boxledjs=boxledjs||{};
...
[];for(e=0;e<this.numTilesX;e++){n=[];for(b=0;b<this.numTilesY;b++)d=b*this.numTilesX+e,c=a[d],j=this.map.getTileProperties(c),0!=c&&void 0!=c&&(j&&j.type&&""!=j.type?(l={},l.properties=j,l.x=e,l.y=b,g=boxledjs.ObjectLayer.makeObjectFromData(l),g.regX=this.map.data.tilewidth/2,g.regY=this.map.data.tileheight/2):(l=this.map.getTileById(c),g=new createjs.Bitmap(l.image),g.sourceRect=l.rect),g.x=e*this.map.data.tilewidth,g.y=b*this.map.data.tileheight,g.properties=j,this.addChild(g),this.tileObjects[d]=
g),this.isCollisionLayer?(this.colTilesToCheck[d]=c,d=!Box2DUtils.isTileCollideable(j,c)):d=!j||"false"!=j.passable,n.push(d?GraphNodeType.OPEN:GraphNodeType.WALL);k.push(n)}this.pathfinding.graph=new Graph(k)};b.prototype.calculateCollisionShapes=function(){var a,e,b,d,c=this.map.data.tilewidth,l=this.map.data.tileheight;for(b=0;b<this.numTilesY;b++)for(e=0;e<this.numTilesX;e++)a=b*this.numTilesX+e,a=this.colTilesToCheck[a],void 0!=a&&0!=a&&(this.colTileGroups.push({tiles:[]}),this.findNextCollisionShapeTile(e,
b));a=0;for(d=this.colTileGroups.length;a<d;a++){var g=this.colTileGroups[a],j=g.tiles;e=j[0].x;b=j[0].y;j=j[j.length-1].x-e+1;g=this.map.getTileProperties(g.tileid)||{};g={x:e*c,y:b*l,width:j*c,height:1*l,properties:g};j=boxledjs.Box2DUtils.makeB2DBodyFromData(g,this.map.b2dWorld);if((e=this.tileObjects[b*this.numTilesX+e])&&e.properties&&e.properties.type){if(j.SetUserData(e),e.bxd=e.bxd||{},e.bxd.body=j,Box2DUtils.injectOnTick(e),e.onBodyCreated)e.onBodyCreated(j)}else j.SetUserData(g)}};b.prototype.findNextCollisionShapeTile=
function(a,e){a=a||0;e=e||0;var b,d,c;b=e*this.numTilesX+a;d=this.colTilesToCheck[b];if(void 0!=d&&0!=d&&(c=this.colTileGroups[this.colTileGroups.length-1],c.tileid=c.tileid||d,Object.equals(this.map.getTileProperties(d),this.map.getTileProperties(c.tileid))&&(!c.tiles.length||!(this.map.getTileProperties(d)&&void 0!=this.map.getTileProperties(d).type))))c.tiles.push({x:a,y:e,tileid:d}),this.colTilesToCheck[b]=void 0,this.findNextCollisionShapeTile(a+1,e)};c.TileLayer=b})(boxledjs);boxledjs=boxledjs||{};boxledjs.Const={};boxledjs.Const.scale=32;
...
new Box2D.Dynamics.b2World(new Box2D.Common.Math.b2Vec2(parseFloat(this.data.properties.forceX)||0,parseFloat(this.data.properties.forceY)||20),!0);var a=new boxledjs.PlatformerContactListener;this.b2dWorld.SetContactListener(a)}this.firstTick=!1;this.generateTileSets()};b.prototype.destroy=function(){var a,b;if(this.b2dWorld){for(b=this.b2dWorld.GetBodyList();b;){var c=b;b=b.GetNext();this.b2dWorld.DestroyBody(c)}delete this.b2dWorld}this.parent&&this.parent.removeChild(this);for(a in this.objects)b=
this.objects[a],b.destroy&&b.destroy(),b.parent&&(b.parent.removeChild(b),delete this.objects[a]);delete this.objects;for(a in this.layers)b=this.layers[a],b.destroy();delete this.layers;this.removeAllChildren();return!0};b.prototype.onTick=function(){!this._firstTick&&this._onFirstTick();this.centerObject&&this.centerTo(this.centerObject)};b.prototype._onFirstTick=function(){var a=boxledjs.Utils.getStage(this).canvas;void 0==this.viewPort.width&&(this.viewPort.width=a.width);void 0==this.viewPort.height&&
...
c,d){var h=this.pathfinding.graph.nodes;a=h[a.x][a.y];b=h[b.x][b.y];if((a=astar.search(h,a,b,c))&&a.length&&!0===d){d=!1;for(var l,g=0;g<a.length-2;g++)for(d=!1;!d&&a[g+2];)b=a[g].x-a[g+1].x,c=a[g].y-a[g+1].y,h=a[g].x-a[g+2].x,l=a[g].y-a[g+2].y,0==h&&0==b||0==l&&0==c?a.splice(g+1,1):d=!0}return a};b.prototype.generateTileSets=function(){this.tilesets=[];this.tileproperties={};for(var a=this.loadedSets=0,c=this.data.tilesets.length;a<c;a++){var f=b.convertTileSetToSpriteSheet(this.data.tilesets[a]);
this.tilesets.push(f);for(var d in f.tileproperties){var h=f.tileproperties[d],l;for(l in h){var g=h[l];0==g.indexOf("[")&&(h[l]=JSON.parse(g))}this.tileproperties[d]=h}if(f.complete)this.loadedSets++;else{var j=this;f.addEventListener("complete",function(){j.setsLoaded()})}}this.loadedSets==c&&this.setsLoaded()};b.prototype.setsLoaded=function(){this.setsLoaded++;this.loadedSets==this.data.tilesets.length&&(this.setupLayers(),this.initialized=!0)};b.prototype.getTileById=function(a){a-=1;return this.getSpriteSheetByTileId(a).getFrame(a)};
b.prototype.getSpriteSheetByTileId=function(a){a=a||1;var b=this.tilesets,c,d,h,l;c=0;for(d=b.length;c<d;c++)h=b[c],h.firstgid<=a&&0<h.firstgid&&(l=h);return l};b.prototype.getTileProperties=function(a){return this.tileproperties[a-1]};b.convertTileSetToSpriteSheet=function(a){var b={};b.images=[a.image];b.frames={width:a.tilewidth,height:a.tileheight};b=new createjs.SpriteSheet(b);b.firstgid=a.firstgid;b.tileproperties=a.tileproperties;return b};c.Map=b})(boxledjs);
